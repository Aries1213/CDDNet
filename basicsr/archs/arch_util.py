...
class LKAT(nn.Module):
    def __init__(self, num_feat):
        ...
        self.att = nn.Sequential(
            nn.Conv2d(num_feat, num_feat, 7, 1, 7 // 2, groups=num_feat),
            nn.Conv2d(num_feat, num_feat, 9, stride=1, padding=(9 // 2) * 3, groups=num_feat, dilation=3),
            nn.Conv2d(num_feat, num_feat, 1, 1, 0))
 
        self.conv1 = nn.Conv2d(num_feat, num_feat, 1, 1, 0)
