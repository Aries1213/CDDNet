...
from .SpatialDropout_arch import SpatialDropoutheng, SpatialDropoutshu
# from .pc_arch import PCAB
from basicsr.utils.registry import ARCH_REGISTRY
from .arch_util import ResidualBlockNoBNDynamic, make_layer, Dynamic_conv2d, LKAT
...
class MSRResNetDynamic(nn.Module):
    ...
    def __init__(self, num_in_ch=3, num_out_ch=3, num_feat=64, num_block=16, num_models=5, upscale=4):
        ...
        self.RC = LKAT(num_feat)
        self.conv_last = Dynamic_conv2d(num_feat, num_out_ch, 3, groups=1, if_bias=True, K=num_models)
        

        # self.PCAB = PCAB(64, 2)
        self.dropout1 = SpatialDropoutheng(0.2)
        self.dropout2 = SpatialDropoutshu(0.01)
        # activation function
