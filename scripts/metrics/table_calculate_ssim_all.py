...
def main():
    ...
    log_save_path = '/root/DASR/results/table_logs_all/'
    data_root = '/root/DASR/results/DASR'
    ref_root = '/root/autodl-tmp/datasets/'
    # ref_dirs = ['DIV2K/DIV2K_valid_HR']
    # ref_dirs = ['Set14/GTmod12']
    # ref_dirs = ['Set5/GTmod12']
    # ref_dirs = ['BSDS100/BSDS100']
    ref_dirs = ['Urban100/GTmod12']
    # datasets = ['DIV2K_bicubic']
    # datasets = ['DIV2K_type1']
    # datasets = ['DIV2K_type2']
    # datasets = ['DIV2K_type3']
    # datasets = ['Set14']
    # datasets = ['Set5']
    # datasets = ['BSDS100']
    datasets = ['Urban100']
    ...
    logoverall_path = log_save_path + 'all_avgs/SSIM_all_avgs.txt'
    ...
    for index in range(len(ref_dirs)):
        ...
        for method in methods:
            ...
            log_path = log_save_path + 'SSIM__' + method + '__' + datasets[index] + '.txt'
            ...
            if not os.path.exists(log_path):
                ...
                for i, img_path in enumerate(img_list):
                    ...
                    try:
                        ...
                        log = f'{i + 1:3d}: {file_name:25}. \tSSIM: {ssim:.6f}.'
                        with open(log_path, 'a') as f:
                            f.write(log + '\n')
                    except:
                        pass
                log = f'Average: SSIM: {sum(ssim_all) / len(ssim_all):.6f}'
                with open(log_path, 'a') as f:
                    f.write(log + '\n')
